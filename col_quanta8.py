...
# 20/03/2018  added statistical tests in a separate menu, but output file of Dunn's test wrong

# 21/03/2018  Dunn's test module collected from Github does not give same p-values as R
#             corrected format of dataframe for Dunn's test output
...
from scipy.stats import mannwhitney_exact_v2 as MW #home-made script for exact p-value calculation
from scipy.stats import dunn_test #collected from github
